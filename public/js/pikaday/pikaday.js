...
}(this, function (moment)
{
    ...
    renderTitle = function(instance, c, year, month, refYear)
    {
        ...
        monthHtml = '<div class="pika-label">' + opts.i18n.months[month] + opts.monthSuffix +'<select class="pika-select pika-select-month">' + arr.join('') + '</select></div>';
    ...
    Pikaday.prototype = {
        ...
        draw: function(force)
        {
            ...
            for (var c = 0; c < opts.numberOfMonths; c++) {
                html += '<div class="pika-header">조회 시작</div>'+
                    '<div class="pika-lendar">' + renderTitle(this, c, this.calendars[c].year, this.calendars[c].month, this.calendars[0].year) + this.render(this.calendars[c].year, this.calendars[c].month) + '</div>';
            }
