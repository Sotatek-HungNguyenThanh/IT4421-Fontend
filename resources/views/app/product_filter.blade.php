...
@section('script')
    ...
    <script src="/js/angular/guest/ProductFilterController.js"></script>
@endsection
@section('css')
    <style>
        .sidebar-collection {
...
@section('content')
    <section id="collection" class="collection" ng-controller="ProductFilterController as controller">
        <div class="container">
