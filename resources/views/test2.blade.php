                            ...
                            <div class="product__view__image--list">
                                <div class="bx-wrapper" style="max-width: 100%;">
                                    ...
                                    <div class="bx-controls bx-has-controls-direction">
                                        <div class="bx-controls-direction"><a class="bx-prev disabled" href=""><i
                                                        class="fa fa-chevron-left" aria-hidden="true"></i></a><a
                                                    class="bx-next disabled" href=""><i class="fa fa-chevron-right"
                        ...
                        <div class="product__view__content col-lg-7 col-md-7 col-sm-6 col-xs-12" itemprop="offers"
                                    ...
                                    <div class="actions-qty">
                                        ...
                                        <buttion class="hotline detail-hotline" aria-label="Hotline"
                                                 ...
                                                 onclick="window.location.href='tel:1900 1009'"><i
                                                    class="fa fa-volume-control-phone" aria-hidden="true"></i> Hotline:
                                            1900 1009
                                        </buttion>
                                    </div>
                            ...
                            <div class="product__view__content--social">
                                ...
                                <div class="addthis_native_toolbox"
                                     data-url="http://amobile.bizwebvietnam.net/lenovo-s8"></div>
                            </div>
                        </div>
                    </div>
                </div>
