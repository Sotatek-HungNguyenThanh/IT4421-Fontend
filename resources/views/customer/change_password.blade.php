                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 register-account">
                            <div class="page-content">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-9 col-sm-9">
                                        <input type="password" name="newPassword" id="Home_ContentPlaceHolder_tb_Pasw"
                                               minlength="8" placeholder="Mật khẩu mới..." required>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-3 col-md-3 col-sm-3">
                                    ...
                                    <div class="col-lg-9 col-md-9 col-sm-9">
                                        <input type="password" name="confirmNewPassword"
                                               id="Home_ContentPlaceHolder_tb_ConfirmPasw" minlength="8"
