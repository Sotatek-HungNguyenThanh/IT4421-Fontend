    ...
    <div class="content-account-page col-md-12 col-sm-12 col-xs-12">
        ...
        <section class="main-content account col-md-9 col-sm-8 col-xs-12">
            ...
            <form method="post" action="#" id="formAccountInfo">
                ...
                <div id="Home_ContentPlaceHolder_UACMaster_ControlPlaceHolder_actionChangeAddress">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <h2 class="title-block" style="padding: 5px 0 !important">Sửa địa chỉ</h2>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 register-account">
                            <div class="page-content">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        <p><strong>Địa chỉ thanh toán mặc định</strong></p>
                                    </div>
                                </div>
                                <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 register-account">
                            <div class="page-content">
                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-md-3 col-sm-3">
                                        <p>Tên đầy đủ <span class="require">*</span></p>
                                    </div>
                                    <div class="col-lg-9 col-md-9 col-sm-9">
                                        <p>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        <input type="submit" name="ctl00$ctl00$Home_ContentPlaceHolder$UACMaster_ControlPlaceHolder$btn_UpdateAddr" value="Lưu thông tin" id="Home_ContentPlaceHolder_UACMaster_ControlPlaceHolder_btn_UpdateAddr" class="button orange">
                                    </div>
                                </div>
                            </div>
                        </div>
